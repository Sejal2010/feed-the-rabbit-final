...
function setup() 
{
  ...
  ground = new Ground(250,height,700,20);
  blink.frameDelay = 20;
  eat.frameDelay = 20;
  ...
  starg=createSprite(50,20,30,30);
  starg.addAnimation("empty",gStar)
  starg.addAnimation("1",one_Star)
  starg.addAnimation("2",two_star)
  starg.changeAnimation("empty")
  starg.scale=0.2
}
...
star1.visible=false;
starg.changeAnimation("1")
}
if (collide(fruit,star2,20)){
  star2.visible=false;
  starg.changeAnimation("2")
  }
